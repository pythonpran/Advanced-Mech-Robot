...
public:
     ...
     */
    template<typename inputFunc_t, typename ArgType, typename outputFunc_t, typename updateFunc_t>
    void tune(inputFunc_t __input_function, ArgType __input_arg, outputFunc_t __output_function, updateFunc_t __update_function) {
